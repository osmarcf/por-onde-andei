<template>
  <ion-page>
    ...
    <ion-content>
      ...
      <div>
        <ion-grid v-for="(registro, index) in list" v-bind:key="index">
          <ion-row>
            <ion-col>Cidade:</ion-col>
            <ion-col>{{ registro.cidade }}</ion-col>
          </ion-row>
          <ion-row>
            <ion-col>Coordenadas:</ion-col>
            <ion-col>{{ registro.coordenadas }}</ion-col>
          </ion-row>
        </ion-grid>
      </div>
    </ion-content>
...
export default defineComponent({
  ...
  methods: {
    ...
    buscaCidade: async function() {
        ...
        this.list.push( { cidade: this.cidade, coordenadas: this.coordenadas } );
